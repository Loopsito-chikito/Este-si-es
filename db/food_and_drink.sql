...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-10-2023 a las 22:28:27
...
DROP PROCEDURE IF EXISTS `C_prd`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `C_prd` ()   BEGIN
	SELECT *FROM producto;
end$$

DROP PROCEDURE IF EXISTS `C_UsuarioCP`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `C_UsuarioCP` (IN `Correo` VARCHAR(60), IN `Contrasena` VARCHAR(50))   BEGIN
    SELECT Correo, Contrasena FROM user 
    WHERE user.Correo = Correo AND 
    user.Contrasena = Contrasena;
END$$

DROP PROCEDURE IF EXISTS `sp_insert_user`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_user` (IN `IdUsuario` INT, IN `TipoDocumento` VARCHAR(30), IN `NoDocumento` INT, IN `Nombre` VARCHAR(40), IN `Apellido` VARCHAR(40), IN `Direccion` VARCHAR(40), IN `Telefono` DOUBLE, IN `Correo` VARCHAR(60), IN `Contrasena` VARCHAR(50), IN `Estado` VARCHAR(50))   BEGIN
IF (SELECT COUNT(*) FROM USER WHERE correo=correo)=0 THEN
	INSERT INTO `user`(`IdUsuario`, `TipoDocumento`, `NoDocumento`, `Nombre`, `Apellido`, `Direccion`, `Telefono`, `Correo`, `Contrasena`, `Estado`) VALUES (IdUsuario,TipoDocumento,NoDocumento,Nombre,Apellido,Direccion,Telefono,Correo,Contrasena,Estado);
    SELECT'USER INSERT' AS errorMessage;
ELSE
	SELECT 'DUPLICATE KEY ERROR' AS errorMesasage;
END IF;
END$$

DROP PROCEDURE IF EXISTS `sp_insert_user_two`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_user_two` (IN `TipoDocumento` VARCHAR(30), IN `NoDocumento` INT, IN `Nombre` VARCHAR(40), IN `Apellido` VARCHAR(40), IN `Direccion` VARCHAR(40), IN `Telefono` DOUBLE, IN `Correo` VARCHAR(60), IN `Contrasena` VARCHAR(50), IN `Estado` VARCHAR(50))   BEGIN
    INSERT INTO user (TipoDocumento, NoDocumento, Nombre, Apellido, Direccion, Telefono, Correo, Contrasena, Estado)
    VALUES (TipoDocumento, NoDocumento, Nombre, Apellido, Direccion, Telefono, Correo, Contrasena, Estado);
END$$

DROP PROCEDURE IF EXISTS `sp_select_all_user`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_select_all_user` ()   BEGIN
SELECT  IdUsuario, TipoDocumento, NoDocumento, Nombre, Apellido, Direccion, Telefono, Correo, Contrasena, Estado FROM user;
END$$

DROP PROCEDURE IF EXISTS `v_usr`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `v_usr` ()   BEGIN
    SELECT * FROM user;
END$$
...
(1, 'CC', '1028784124', 'Camilo', 'García', 'DG 53 No. 32-55 S', 3225478796, 'camilog1@gmail.com', 'sr700', 'Activo'),
(2, 'CC', '1027781124', 'Cristian', 'Garzón', 'Cll 53 No 20-57 S', 3125472790, 'camilocrg2@gmail.com', 'ir720', 'Activo'),
(3, 'CC', '1068784057', 'David', 'Díaz', 'Cll 13 No 36-11 S', 3052669871, 'DDdiaz114@gmail.com', 'DDdavidz18', 'Activo'),
...
(11, 'CC', '6199484022', 'Alejandro', 'Palacio', 'Cll 23 No 26-15 S', 3192609873, 'alejoBGP6@gmail.com', 'alejo20068', 'Activo'),
...
(14, 'CC', '1169481051', 'Esteban', 'Herrera', 'DG 23 No 26-18 O', 3152115171, 'estebanH120@gmail.com', 'es234h1', 'Activo'),
...
(18, 'CC', '2169467528', 'Daniel', 'Rodríguez', 'DG 12 No 3-56 S', 3059969894, 'DaniRorX@gmail.com', 'DanielRodri1987', 'Activo'),
(19, 'CC', '1102487957', 'Javier', 'Sierra', 'Cra 11 No 76-03 O', 3152969371, 'javierSdiaz@gmail.com', 'sierraDdavid', 'Activo'),
(20, 'CC', '9659484157', 'Johan', 'González', 'Cll 13 No 37-11 N', 3052609861, 'johanGon47@hotmail.com', 'johanvid18', 'Activo'),
...
(23, 'CC', '2163485027', 'Mateo', 'Triana', 'DG 23 No 38-31 E', 3162659812, 'mathtri14@gmail.com', 'mateoTriana2003', 'Activo'),
(24, 'CC', '1229284257', 'Andrés', 'Marín', 'Cll 13 No 36-12 S', 3152669803, 'andresmar10@outlook.com', 'anMDdavidz9', 'Activo'),
(25, 'CC', '1645689452', 'Diego', 'Rojas', 'Cll 12 No 63-23 S', 3132640022, 'lopolilolilopolo@gmail.com', 'aguamarga', 'Inactivo');
...
--
-- Volcado de datos para la tabla `lostdomiciliario`
--

INSERT INTO `lostdomiciliario` (`IDLost`, `Tipocrud`, `UserCrud`, `FechaCrud`, `OLDIdDomiciliario`, `OLDTipoDocumento`, `OLDNoDocumento`, `OLDNombre`, `OLDApellido`, `OLDDireccion`, `OLDTelefono`, `OLDCorreo`, `OLDContrasena`, `OLDEstado`, `NEWIdDomiciliario`, `NEWTipoDocumento`, `NEWNoDocumento`, `NEWNombre`, `NEWApellido`, `NEWDireccion`, `NEWTelefono`, `NEWCorreo`, `NEWContrasena`, `NEWEstado`) VALUES
(0, 'Update', 'root@localhost', '2023-08-31', 11, 'TI', '6199484022', 'Alejandro', 'Palacio', 'Cll 23 No 26-15 S', 3192609873, 'alejoBGP6@gmail.com', 'alejo20068', 'Activo', 11, 'CC', '6199484022', 'Alejandro', 'Palacio', 'Cll 23 No 26-15 S', 3192609873, 'alejoBGP6@gmail.com', 'alejo20068', 'Activo'),
(0, 'Update', 'root@localhost', '2023-08-31', 14, 'TI', '1169481051', 'Esteban', 'Herrera', 'DG 23 No 26-18 O', 3152115171, 'estebanH120@gmail.com', 'es234h1', 'Activo', 14, 'CC', '1169481051', 'Esteban', 'Herrera', 'DG 23 No 26-18 O', 3152115171, 'estebanH120@gmail.com', 'es234h1', 'Activo'),
(0, 'Update', 'root@localhost', '2023-08-31', 1, 'TI', '1028784124', 'Camilo', 'García', 'DG 53 No. 32-55 S', 3225478796, 'camilog1@gmail.com', 'sr700', 'Activo', 1, 'CC', '1028784124', 'Camilo', 'García', 'DG 53 No. 32-55 S', 3225478796, 'camilog1@gmail.com', 'sr700', 'Activo'),
(0, 'Update', 'root@localhost', '2023-08-31', 3, 'TI', '1068784057', 'David', 'Díaz', 'Cll 13 No 36-11 S', 3052669871, 'DDdiaz114@gmail.com', 'DDdavidz18', 'Activo', 3, 'CC', '1068784057', 'David', 'Díaz', 'Cll 13 No 36-11 S', 3052669871, 'DDdiaz114@gmail.com', 'DDdavidz18', 'Activo'),
(0, 'Update', 'root@localhost', '2023-08-31', 18, 'TI', '2169467528', 'Daniel', 'Rodríguez', 'DG 12 No 3-56 S', 3059969894, 'DaniRorX@gmail.com', 'DanielRodri1987', 'Activo', 18, 'CC', '2169467528', 'Daniel', 'Rodríguez', 'DG 12 No 3-56 S', 3059969894, 'DaniRorX@gmail.com', 'DanielRodri1987', 'Activo'),
(0, 'Update', 'root@localhost', '2023-08-31', 20, 'TI', '9659484157', 'Johan', 'González', 'Cll 13 No 37-11 N', 3052609861, 'johanGon47@hotmail.com', 'johanvid18', 'Activo', 20, 'CC', '9659484157', 'Johan', 'González', 'Cll 13 No 37-11 N', 3052609861, 'johanGon47@hotmail.com', 'johanvid18', 'Activo'),
(0, 'Update', 'root@localhost', '2023-08-31', 23, 'TI', '2163485027', 'Mateo', 'Triana', 'DG 23 No 38-31 E', 3162659812, 'mathtri14@gmail.com', 'mateoTriana2003', 'Activo', 23, 'CC', '2163485027', 'Mateo', 'Triana', 'DG 23 No 38-31 E', 3162659812, 'mathtri14@gmail.com', 'mateoTriana2003', 'Activo'),
(0, 'Update', 'root@localhost', '2023-08-31', 24, 'TI', '1229284257', 'Andrés', 'Marín', 'Cll 13 No 36-12 S', 3152669803, 'andresmar10@outlook.com', 'anMDdavidz9', 'Activo', 24, 'CC', '1229284257', 'Andrés', 'Marín', 'Cll 13 No 36-12 S', 3152669803, 'andresmar10@outlook.com', 'anMDdavidz9', 'Activo'),
(0, 'Update', 'root@localhost', '2023-08-31', 25, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 25, 'CC', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(0, 'Update', 'root@localhost', '2023-08-31', 25, 'CC', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 25, 'CC', '1645689452', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(0, 'Update', 'root@localhost', '2023-08-31', 25, 'CC', '1645689452', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 25, 'CC', '1645689452', 'Diego', NULL, NULL, NULL, NULL, NULL, NULL),
(0, 'Update', 'root@localhost', '2023-08-31', 25, 'CC', '1645689452', 'Diego', NULL, NULL, NULL, NULL, NULL, NULL, 25, 'CC', '1645689452', 'Diego', 'Rojas', NULL, NULL, NULL, NULL, NULL),
(0, 'Update', 'root@localhost', '2023-08-31', 25, 'CC', '1645689452', 'Diego', 'Rojas', NULL, NULL, NULL, NULL, NULL, 25, 'CC', '1645689452', 'Diego', 'Rojas', 'Cll 12 No 63-23 S', NULL, NULL, NULL, NULL),
(0, 'Update', 'root@localhost', '2023-08-31', 25, 'CC', '1645689452', 'Diego', 'Rojas', 'Cll 12 No 63-23 S', NULL, NULL, NULL, NULL, 25, 'CC', '1645689452', 'Diego', 'Rojas', 'Cll 12 No 63-23 S', 313264005622, NULL, NULL, NULL),
(0, 'Update', 'root@localhost', '2023-08-31', 25, 'CC', '1645689452', 'Diego', 'Rojas', 'Cll 12 No 63-23 S', 313264005622, NULL, NULL, NULL, 25, 'CC', '1645689452', 'Diego', 'Rojas', 'Cll 12 No 63-23 S', 3132640022, NULL, NULL, NULL),
(0, 'Update', 'root@localhost', '2023-08-31', 25, 'CC', '1645689452', 'Diego', 'Rojas', 'Cll 12 No 63-23 S', 3132640022, NULL, NULL, NULL, 25, 'CC', '1645689452', 'Diego', 'Rojas', 'Cll 12 No 63-23 S', 3132640022, 'lopolilolilopolo@gmail.com', NULL, NULL),
(0, 'Update', 'root@localhost', '2023-08-31', 25, 'CC', '1645689452', 'Diego', 'Rojas', 'Cll 12 No 63-23 S', 3132640022, 'lopolilolilopolo@gmail.com', NULL, NULL, 25, 'CC', '1645689452', 'Diego', 'Rojas', 'Cll 12 No 63-23 S', 3132640022, 'lopolilolilopolo@gmail.com', 'aguamarga', NULL),
(0, 'Update', 'root@localhost', '2023-08-31', 25, 'CC', '1645689452', 'Diego', 'Rojas', 'Cll 12 No 63-23 S', 3132640022, 'lopolilolilopolo@gmail.com', 'aguamarga', NULL, 25, 'CC', '1645689452', 'Diego', 'Rojas', 'Cll 12 No 63-23 S', 3132640022, 'lopolilolilopolo@gmail.com', 'aguamarga', 'Inactivo');
...
INSERT INTO `user` (`IdUsuario`, `TipoDocumento`, `NoDocumento`, `Nombre`, `Apellido`, `Direccion`, `Telefono`, `Correo`, `Contrasena`, `Estado`) VALUES
(1, 'CC', 123456789, 'Joan', 'Barreto', 'Calle 12 # 16-44', 3196824766, 'El.lopsss15@gmail.com', 'Michi1205', 'Activo'),
(2, 'CC', 103457698, 'Juan', 'Ventero', 'Calle 85 # 18-84', 8286313281, 'ESapomadako14@gmail.com', 'Roger1205', 'Activo'),
(3, 'CC', 101337236, 'Sebastian', 'Rojas', 'Diagonal 20 # 18-34', 2915790650, 'salchipapa2315@gmail.com', 'Neron1205', 'Inactivo'),
(4, 'CC', 109365597, 'Carlos', 'Sanches', 'Calle 32 # 18-38', 2883058893, 'Elmatarukas35@gmail.com', 'Palomo1205', 'Activo'),
(5, 'CC', 213231321, 'Dylan', 'Morales', 'Calle 62 # 25-37', 6951136946, 'Elsarabambiche45@gmail.com', 'Moran:305', 'Activo'),
(6, 'CC', 104293243, 'Luis', 'Perez', 'Calle 38 # 15-31', 9070680530, 'Gokussjfase45@gmail.com', 'constrasena', 'Activo'),
(7, 'CC', 110437855, 'Nixon', 'Ventero', 'Calle 72 # 15-21', 5653164631, 'lagorda455@gmail.com', '123456789', 'Activo'),
(8, 'CC', 104373348, 'Diana', 'Castaño', 'Calle 45 # 15-43', 5298947092, 'Elfifas20315@gmail.com', 'Mipapi1205.', 'Activo'),
(9, 'CC', 102686818, 'David', 'Montaña', 'Calle 58 # 15-65', 2219817013, 'Soygay75@gmail.com', 'SiSeñor', 'Activo'),
(10, 'CC', 107011168, 'Roger', 'Martinez', 'Calle 92 # 15-87', 6210822725, 'ElArmadillo16@gmail.com', 'elAbocato', 'Activo'),
(11, 'CC', 103824328, 'Alfredo', 'Gomez', 'Calle 43 # 85-39', 4407337610, 'ElBunuelitorico16@gmail.com', 'Michichun', 'Activo'),
(12, 'CC', 105750558, 'Haider', 'Aguilera', 'Calle 84 # 5-14', 6210234332, 'ElNegroafricano15@gmail.com', 'Elchimbo21', 'Inactivo'),
(13, 'CC', 105314942, 'Brandon', 'Ospina', 'Calle 98 # 10-64', 6199552730, 'holacomoestas@gmail.com', 'Mipoto32', 'Activo'),
(14, 'CC', 145851492, 'Andrés', 'Martinez', 'Calle 43 # 85-74', 6322913061, 'Ventiuna16@gmail.com', 'Michigan', 'Activo'),
(15, 'CC', 109776475, 'Felipe', 'Jaramillo', 'Calle 11 # 87-19', 6244266405, 'Elquegrita16@gmail.com', 'SebasUwU', 'Activo'),
(16, 'CC', 107250611, 'Jhoan', 'Armando', 'Calle 13 # 95-54', 2347191127, 'Alfonso16@gmail.com', 'ElMoscoosi', 'Activo'),
(17, 'CC', 198524036, 'Sebastian', 'Cruz', 'Calle 92 # 85-64', 9598618451, 'Juanca77@gmail.com', 'Rogertero', 'Activo'),
(18, 'CC', 121765432, 'Alexander', 'Barreto', 'Calle 82 # 17-44', 2432999109, 'teoriaeliocebnt85@gmail.com', 'elhiervat', 'Activo'),
(19, 'CC', 185962476, 'Yolis', 'Pabon', 'Calle 72 # 17-39', 3993602255, 'ElQUintana18@gmail.com', 'NublaoUwU', 'Inactivo'),
(20, 'CC', 156987742, 'Amalia', 'Florez', 'Calle 62 # 14-32', 7140582612, 'Etesechs598@gmail.com', 'Elfurro21', 'Activo'),
(21, 'CC', 163559874, 'Seis', 'Martinez', 'Calle 52 # 18-36', 2469244169, 'Elbucle875@gmail.com', 'Movilecod', 'Activo'),
(22, 'CC', 158200647, 'Julian', 'Sanches', 'Calle 42 # 19-54', 7001575900, 'Epasiseñor75@gmail.com', 'Michujara', 'Activo'),
(23, 'CC', 185436927, 'Esteban', 'Quintero', 'Calle 32 # 95-44', 1032432749, 'Tengosda35@gmail.com', 'Michapero', 'Activo'),
(24, 'CC', 174986523, 'Jesus', 'Garcia', 'Calle 22 # 93-84', 4025901898, 'Vamosquesisepuede35@gmail.com', 'Dorime12', 'Activo'),
(25, 'CC', 184235689, 'Alex', 'Torres', 'Calle 12 # 65-14', 4681412600, 'GraciasSENA32@gmail.com', 'ElAmadadoulli', 'Inactivo'),
(26, 'CC', 103545879, 'Juan', 'Martinez', 'callefalsa#1234', 1035486579, 'saquenemdelatam@gmail.com', 'ultrasecreto', 'activo'),
(27, 'CC', 12264879, 'Mauro', 'Yovani', 'callefaslta#34', 12354688, 'felipe@gmail.com', 'diego12345', 'activo'),
(28, 'CC', 12312314, 'Juan', 'eentero', 'calle2341', 3134646541, 'jkuasnd@gauil.com', 'pyphone', 'Activo');
...
ALTER TABLE `pedido`
  ...
  ADD CONSTRAINT `pedido_ibfk_2` FOREIGN KEY (`IdUsuario`) REFERENCES `user` (`IdUsuario`);
COMMIT;
